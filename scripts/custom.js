(function($) {
      ...
      $(document).ready(function(){
                ...
                $('.load-service').magnificPopup({
                          type : 'ajax',
                          ajax: {
                                tError: 'Broken link or the server does not support ajax requestest! Please check the link or use a webserver for work if needed!'
                                },
                          callbacks: {
                ...
                /*-- Show Form --*/
                $('a[data-role="show-form"]').on('click', function(e) {
                          e.preventDefault();
                ...
                ================================================*/
                $('#elastic-contact-form button#elastic-send').on('click', function(e) {
      ...
      $(window).load(function(){
                ...
                /*-- Load Items via Ajax --*/
                $('a.ajax-load, .project-contents a.more-link').on('click', function(e) {
                           e.preventDefault();
