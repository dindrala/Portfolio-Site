(function($) {
      ...
      $(document).ready(function () {
                ...
                $('html,body').stop().animate({scrollTop: $(window).scrollTop()+1},'slow');
                ...
                $('.question-tab').click(function(){
                        ...
                        $(this).parent().find('div.question-answer').slideToggle();
                });


          var AFFIX_TOP_LIMIT = 1387;
          var AFFIX_OFFSET = 50;

          var Offset = $(".docs-nav").offset();
          var leftOffset = Offset.left;
          var topOffset = Offset.top;
          $(".docs-nav").css("left",leftOffset);
